...
#CV 10 vs. CV 3: Computationally expensive or not?
# Import necessary modules
from sklearn.linear_model import LinearRegression
from sklearn.model_selection import cross_val_score
...
#Regularization
#Lasso Regression: Lasso is great for feature selection (L1)
...
#Regularization II: Ridge (L2)
#When building regression models, Ridge regression should be your first choice
#Took the sum of the squared values of the coefficients multiplied by some alpha
# Import necessary modules
